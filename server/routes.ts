    ...
    try {
      const input = z.object({
        job: z.object({
          ...
          manifestDumpLocation: z.string().nullable().optional(),
          manifestDumpLocationName: z.string().nullable().optional(),
          scheduledDumpTimes: z.array(z.string()).nullable().optional(),
